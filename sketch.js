...
function setup() {
  ...
  trex.addAnimation("running",boy_running);
  trex.scale = 0.1;
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(garbageGroup.isTouching(trex)){
...
function spawnGarbage(){
  if(frameCount % 50 === 0) {
    var garbage = createSprite(600,140,200, 200);
    //obstacle.debug = true;
    //generate random obstacles
